...
const ProfilePageRefined = () => {
  ...
  const onPencilIconClick = useCallback(() => {
    navigate("/profile-page-refined-1");
  }, [navigate]);
  ...
  return (
    <div className="w-full relative h-[844px] text-left text-xl text-colors-neutral-white font-poppins">
      ...
      <img
        className="absolute h-[4.27%] w-[10.51%] top-[8.53%] right-[3.85%] bottom-[87.2%] left-[85.64%] max-w-full overflow-hidden max-h-full object-cover cursor-pointer"
        alt=""
        src="/pencil@2x.png"
