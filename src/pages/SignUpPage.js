...
const SignUpPage = () => {
  ...
  return (
    <div className="w-full relative rounded-17xl bg-black h-[844px] overflow-hidden flex flex-col items-start justify-start p-2.5 box-border gap-[10px] text-left text-base text-colors-neutral-white font-poppins">
      ...
      />
      <div
        className="w-[337px] absolute !m-[0] top-[672px] left-[26px] rounded-xl bg-deepskyblue-300 h-[59px] cursor-pointer z-[16]"
        onClick={onRectangle4Click}
      />
      <b className="w-[95px] absolute !m-[0] top-[687px] left-[calc(50%_-_32px)] inline-block h-[29px] shrink-0 z-[17]">
        Sign up
      </b>
    </div>
  );
