  ...
  return (
    <div className="w-[302px] h-[291px] max-w-full max-h-full overflow-auto text-left text-base text-colors-neutral-white font-inter">
      ...
      <img
        ...
        src="/icon-plus.svg"
      />
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute h-[7.22%] w-[21.36%] top-[35.05%] right-[34.6%] bottom-[57.73%] left-[44.04%]">
        <div className="absolute h-[95.24%] w-[31.01%] top-[0%] right-[27.13%] bottom-[4.76%] left-[41.86%] rounded-[50%] bg-gainsboro-200 box-border border-[2px] border-solid border-colors-neutral-white" />
        <div className="absolute h-[7.62%] w-[16.12%] top-[43.81%] right-[34.57%] bottom-[48.57%] left-[49.3%] rounded-12xs bg-colors-neutral-white" />
        <img
      ...
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute h-[6.87%] w-[6.62%] top-[57.39%] right-[31.46%] bottom-[35.74%] left-[61.92%]">
      ...
      <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute h-[6.87%] w-[6.62%] top-[35.05%] right-[31.46%] bottom-[58.08%] left-[61.92%]">
        <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-[50%] bg-gainsboro-200 box-border border-[2px] border-solid border-colors-neutral-white" />
        <div className="absolute h-[8%] w-[52%] top-[46%] right-[24%] bottom-[46%] left-[24%] rounded-12xs bg-colors-neutral-white" />
        <div className="absolute h-[8%] w-[52%] top-[24%] right-[-6%] bottom-[68%] left-[54%] rounded-12xs bg-colors-neutral-white [transform:_rotate(90deg)] [transform-origin:0_0]" />
