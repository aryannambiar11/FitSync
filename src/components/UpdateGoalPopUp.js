...
const UpdateGoalPopUp = ({ onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className="absolute center w-[310px] h-[230.1px] cursor-pointer max-w-full max-h-full overflow-auto text-left text-xl text-colors-neutral-white font-poppins"
