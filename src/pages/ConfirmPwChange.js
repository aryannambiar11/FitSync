...
const ConfirmPwChange = () => {
  ...
  return (
    <div className="w-full relative rounded-17xl bg-black h-[844px] overflow-hidden text-center text-13xl text-colors-neutral-white font-poppins">
      ...
      <div className="absolute top-[402px] left-[26px] w-[337px] h-[59px] text-left text-base">
        <div
          className="absolute top-[0px] left-[0px] rounded-xl bg-deepskyblue-300 w-[337px] h-[59px] cursor-pointer"
          onClick={onRectangleClick}
        />
        <b className="absolute top-[15px] left-[calc(50%_-_29.5px)] inline-block w-[60px] h-[29px]">
